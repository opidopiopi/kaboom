...
namespace Kaboom.Testing.Domain
{
    ...
    public partial class ArrangementTests
    {
        ...
        public void arrangement_can_remove_window_and_return_object()
        {
            ...
            var window = new Window(new Kaboom.Abstraction.Rectangle(1, 1, 1, 1), "test");
        ...
        public void arrangement_for_all_underlying_windows()
        {
            ...
            Window[] windows = Enumerable.Range(0, 6).Select(i => new Window(new Kaboom.Abstraction.Rectangle(1, 1, 1, 1), "test")).ToArray();
